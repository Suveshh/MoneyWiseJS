  ...
  const filteredMentors = mentors.filter((mentor) => {
    ...
    const matchesExperience =
      ...
      (selectedExperience === "mid" &&
        parseInt(mentor.experience) >= 8 &&
        parseInt(mentor.experience) < 15) ||
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {mentor.achievements.map((achievement, index) => (
                  <div
                    key={index}
                    className="flex items-center text-xs text-neutral-600 dark:text-neutral-400"
                  >
              ...
              <div className="flex space-x-3">
                ...
                <button className="px-4 py-2 border border-neutral-300 dark:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg font-medium transition-colors flex items-center">
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 mb-6 max-w-2xl mx-auto">
              Join live group sessions and webinars with market experts. Ask
              questions in real-time and learn from other students.
            </p>
